  ...
  const onSubmit = async (e) => {
    try {
      ...
      if (!email || email === undefined || !validEmail(email)) {
        new AWN().alert("Email Address not valid. Kindly enter a valid Email Address.", {
              ...
              <div className="card  bg-gradient">
                <div className="card-body p-4">
                  <div className="text-center w-75 m-auto">
                    ...
                    <p className="text-muted mb-4 mt-3">Enter your email address and password to access your account.</p>
                  </div>
